...
VL53L5CX_Configuration configDev;        // Sensor condfiguration struct
...
bool SparkFun_VL53L5CX::begin(byte address, TwoWire &wirePort)
{
    ...
    result = vl53l5cx_init(&configDev);
...
bool SparkFun_VL53L5CX::isConnected()
{
    ...
    uint8_t alive = 0;
    result = vl53l5cx_is_alive(&configDev, &alive);
    if (result != 0)
    {
...
bool SparkFun_VL53L5CX::setAddress(uint8_t newAddress)
{
    ...
    // uint8_t result = vl53l5cx_set_i2c_address(&configDev, static_cast<uint16_t>(newAddress));
...
bool SparkFun_VL53L5CX::setRangingFrequency(uint8_t newFrequency)
{
    ...
    uint8_t result = vl53l5cx_set_ranging_frequency_hz(&configDev, newFrequency);
    if (result == 0)
        return true;
...
uint8_t SparkFun_VL53L5CX::getRangingFrequency()
{
    ...
    uint8_t frequency = 0;
    uint8_t result = vl53l5cx_get_ranging_frequency_hz(&configDev, &frequency);
    if (result == 0)
    {
        return frequency;
    }
...
bool SparkFun_VL53L5CX::setRangingMode(SF_VL53L5CX_RANGING_MODE rangingMode)
{
    ...
    if (rangingMode == SF_VL53L5CX_RANGING_MODE::AUTONOMOUS)
        result = vl53l5cx_set_ranging_mode(&configDev, VL53L5CX_RANGING_MODE_AUTONOMOUS);
    else
        result = vl53l5cx_set_ranging_mode(&configDev, VL53L5CX_RANGING_MODE_CONTINUOUS);
...
SF_VL53L5CX_RANGING_MODE SparkFun_VL53L5CX::getRangingMode()
{
    ...
    uint8_t rangeMode = 0;
    uint8_t result = vl53l5cx_get_ranging_mode(&configDev, &rangeMode);
    if (result == 0)
    {
        if (rangeMode == 0x01)
...
bool SparkFun_VL53L5CX::startRanging()
{
    ...
    uint8_t result = vl53l5cx_start_ranging(&configDev);
...
bool SparkFun_VL53L5CX::stopRanging()
{
    ...
    uint8_t result = vl53l5cx_stop_ranging(&configDev);
...
bool SparkFun_VL53L5CX::isDataReady()
{
    ...
    uint8_t result = vl53l5cx_check_data_ready(&configDev, &dataReady);
    if (result == 0)
        return dataReady != 0;
...
uint8_t SparkFun_VL53L5CX::getResolution()
{
    ...
    uint8_t result = vl53l5cx_get_resolution(&configDev, &resolution);
    if (result == 0)
    {
        if (resolution == 64)
...
bool SparkFun_VL53L5CX::setResolution(uint8_t resolution)
{
    ...
    uint8_t result = vl53l5cx_set_resolution(&configDev, resolution);
...
bool SparkFun_VL53L5CX::getRangingData(VL53L5CX_ResultsData *pRangingData)
{
    ...
    uint8_t result = vl53l5cx_get_ranging_data(&configDev, pRangingData);
    if (result == 0)
        return true;
...
bool SparkFun_VL53L5CX::setPowerMode(SF_VL53L5CX_POWER_MODE powerMode)
{
    ...
    uint8_t result = vl53l5cx_set_power_mode(&configDev, powerModeValue);
...
SF_VL53L5CX_POWER_MODE SparkFun_VL53L5CX::getPowerMode()
{
    ...
    uint8_t powerModeValue;
    uint8_t result = vl53l5cx_get_power_mode(&configDev, &powerModeValue);
...
bool SparkFun_VL53L5CX::setIntegrationTime(uint32_t timeMsec)
{
    ...
    uint8_t result = vl53l5cx_set_integration_time_ms(&configDev, timeMsec);
...
uint32_t SparkFun_VL53L5CX::getIntegrationTime()
{
    ...
    uint8_t result = vl53l5cx_get_integration_time_ms(&configDev, &integrationTime);
...
bool SparkFun_VL53L5CX::setSharpenerPercent(uint8_t percent)
{
    ...
    uint8_t result = vl53l5cx_set_sharpener_percent(&configDev, percent);
...
uint8_t SparkFun_VL53L5CX::getSharpenerPercent()
{
    ...
    uint8_t percent;
    uint8_t result = vl53l5cx_get_sharpener_percent(&configDev, &percent);
...
bool SparkFun_VL53L5CX::setTargetOrder(SF_VL53L5CX_TARGET_ORDER order)
{
    ...
    uint8_t result = vl53l5cx_set_target_order(&configDev, orderValue);
...
SF_VL53L5CX_TARGET_ORDER SparkFun_VL53L5CX::getTargetOrder()
{
    ...
    uint8_t orderValue;
    uint8_t result = vl53l5cx_get_target_order(&configDev, &orderValue);
